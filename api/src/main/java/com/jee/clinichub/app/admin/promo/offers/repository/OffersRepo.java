package com.jee.clinichub.app.admin.promo.offers.repository;
...
public interface OffersRepo extends JpaRepository<Offers,Long>{
    ...
    @Query("SELECT c FROM Offers c WHERE (:discount IS NULL OR c.discount = :discount)" +
...
Page<OfferProjection> findAdminByNameAndDiscountTypeByCodeAndTime(Pageable pageable,
