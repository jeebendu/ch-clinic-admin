...
public class AIChatController {
    ...
    public ResponseEntity<ChatResponse> sendMessage(@RequestBody ChatRequest request) {
        try {
            ...
            log.error("Error in chat message endpoint: ", e);
    ...
    public ResponseEntity<Boolean> deleteSession(@PathVariable String sessionToken) {
        try {
            boolean deleted = aiChatService.deleteSession(sessionToken);
    ...
    public ResponseEntity<List<ChatSessionDto>> getUserSessions(@PathVariable Long userId) {
        try {
            List<ChatSessionDto> sessions = aiChatService.getUserSessions(userId);
