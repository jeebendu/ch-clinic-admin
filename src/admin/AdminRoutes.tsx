...
import ClinicsRoutes from "./modules/clinics/routes/ClinicsRoutes";
import ClinicProfileRoutes from "./modules/clinic-profile/routes/ClinicProfileRoutes";
...
const AdminRoutes = () => {
  return (
    <Routes>
      ...
      <Route path="/clinic-profile/*" element={<ClinicProfileRoutes />} />
    </Routes>
  );
};
