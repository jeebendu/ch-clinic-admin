  ...
  return (
    <AdminLayout>
      ...
      <FormDialog
        ...
        description="Add a new tenant to your clinic network."
      >
        <TenantForm onSuccess={handleCloseForm} />
      </FormDialog>
      ...
      >
        <TenantForm tenant={tenantToEdit} onSuccess={handleCloseForm} />
      </FormDialog>
